...
--model_depth 101 --resnet_shortcut B --resnext_cardinality 32 --sample_duration 64 --batch_size 30 --pretrain_path hmdb_triplet_finetuned/save_5.pth --ft_begin_index 4 --n_threads 31 --checkpoint 5 \
--n_epochs 200 \
