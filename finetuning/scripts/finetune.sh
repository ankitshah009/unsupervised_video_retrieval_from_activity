...
--model_depth 101 --n_classes 51 --resnet_shortcut B --resnext_cardinality 32 --sample_duration 64 --batch_size 64 --pretrain_path kinetics/resnext-101-64f-kinetics.pth --ft_begin_index 4 --n_threads 32 --checkpoint 5 \
--n_epochs 200 \
